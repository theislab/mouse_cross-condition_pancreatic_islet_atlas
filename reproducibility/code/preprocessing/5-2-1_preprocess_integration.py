...
if False:
    UID3='a'
    STUDY='human_2020'
    FILE='/lustre/groups/ml01/workspace/karin.hrovatin/data/pancreas/scRNA/P21002/rev7/data_annotated.h5ad'
    PATH_RAW='/lustre/groups/ml01/workspace/karin.hrovatin/data/pancreas/scRNA/P21002/rev7/scanpy_AnnData/*/filtered_feature_bc_matrix.h5ad'
    FOR_REF=None
...
if 'for_reference' in metadata.columns.values:
...
path_save='/'.join(FILE.split('/')[:-1])+'/'+'data_normlisedForIntegration.h5ad'
