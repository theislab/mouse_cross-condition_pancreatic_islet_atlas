...
# %%
#C: Can't stay the same as above
N_PCS

# %%
# neighbours on scaled data
sc.pp.neighbors(adata_scl,n_pcs = 19) 
...
#colours=['#ff7f0e', '#2ca02c','#46aaf0','#484848']
colours=['#ff7f0e', '#2ca02c','#46aaf0']
palette=sb.color_palette(colours)
...
adata.uns['phase_cyclone_colors']=colours
...
file_thresholds={'MUC13640':0.55,'MUC13639':0.45,'MUC13633':0.55,'MUC13634':0.55,
                 'MUC13641':0.45,'MUC13631':0.4,'MUC13642':0.5,'MUC13632':0.5}
...
# Use different thresholds across files as there might be different ambient counts (or other effects), 
# thus shifting distributions up a bit
file_thresholds={'MUC13640':0.55,'MUC13639':0.6,'MUC13633':0.55,'MUC13634':0.55,
                 'MUC13641':0.6,'MUC13631':0.5,'MUC13642':0.5,'MUC13632':0.55}
...
# Use different thresholds across files as there might be different ambient counts (or other effects), 
# thus shifting distributions up a bit
file_thresholds={'MUC13640':0.5,'MUC13639':0.5,'MUC13633':0.5,'MUC13634':0.5,
                 'MUC13641':0.5,'MUC13631':0.5,'MUC13642':0.5,'MUC13632':0.5}
adata_rawnorm.obs[score_name+'_high']=scores.apply(lambda x: x[score_name+'_score_norm'] > file_thresholds[x.file], 
                                                   axis=1)
print('Proportion of '+score_name+' high across samples:')
adata_rawnorm.obs[['file',score_name+'_high']].groupby('file')[score_name+'_high'].value_counts(
...
# Use different thresholds across files as there might be different ambient counts (or other effects), 
# thus shifting distributions up a bit
file_thresholds={'MUC13640':0.73,'MUC13639':0.73,'MUC13633':0.72,'MUC13634':0.72,
                 'MUC13641':0.72,'MUC13631':0.73,'MUC13642':0.71,'MUC13632':0.75}
adata_rawnorm.obs[score_name+'_high']=scores.apply(lambda x: x[score_name+'_score_norm'] > file_thresholds[x.file], 
                                                   axis=1)
print('Proportion of '+score_name+' high across samples:')
adata_rawnorm.obs[['file',score_name+'_high']].groupby('file')[score_name+'_high'].value_counts(
