...
path_data='/lustre/groups/ml01/workspace/karin.hrovatin/data/pancreas/scRNA/salinno_project/rev4/scanpy_AnnData/14*/'
...
ax.axvline(15000,c='k',alpha=0.5)
ax.axvline(30000,c='k',alpha=0.5)
ax.axhline(30,c='k',alpha=0.5)
ax.axhline(10,c='k',alpha=0.5)
...
#p3.set_xscale('log')
p4 = sb.distplot(adata.obs['n_counts'][adata.obs['n_counts']<7000], 
                 kde=False, bins=30, 
                 ax=fig.add_subplot(fig_ind[1]))
#p4.set_xscale('log')
p5 = sb.distplot(adata.obs['n_counts'][adata.obs['n_counts']>30000], 
                 kde=False, bins=60, 
...
p8 = sb.distplot(adata.obs['n_genes'][adata.obs['n_genes']>5500], 
