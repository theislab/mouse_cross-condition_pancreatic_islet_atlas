...
path_de='/lustre/groups/ml01/workspace/karin.hrovatin/data/pancreas/scRNA/combined/de/de_diseased_T1_NODelim_meld/'
...
plt.savefig(path_fig+'umap_beta_DENODelim_clusters.png',dpi=300,bbox_inches='tight')
...
plt.savefig(path_fig+'violin_beta_DENODelimGroups_sample.png',dpi=300,bbox_inches='tight')
...
# %% [markdown]
# #### Potential ambient
# Relative beta expression for each cluster (how likely is it ambient - do genes look predominately ambient - I have before observed that some NOD genes may come from immune cells). It is possible that the potnetial ambient filtering did not remove all ambient genes.
...
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
plt.savefig(path_fig+'violin_beta_DENODelimGroups_relativectexpr.png',dpi=300,bbox_inches='tight')
...
# %%
# genes for anno
genes=['Ttyh1', 'Col27a1','Fabp5','Gc', 'Nucb2','Pde4d',
 'Pon3', 'Slc38a5','Gsto2', 'Cd59a','Cd44','Calb1']+[
    'Ndufa4','Dlk1','Cadm1','Gas6','Tnfsf10','Psmb9','Mt3','Npy','B2m', 'Vgf',
    'Gbp2','Gbp10','Psme1','Cd274'
]
genes_show=[]
genes_show_eid=[]
for g in genes:
...
# png(file=paste0(path_fig,"heatmap_beta_NODelimEmbryo.png"), width=5000, height=5000,res=500)
# h<-Heatmap(x,col=viridis(256),
#        cluster_columns = FALSE, cluster_rows = FALSE,
#        show_column_names = FALSE, show_row_names = TRUE,
#        row_title ="fine cell clusters",
...
# %%
# %R paste0(path_fig,"heatmap_beta_NODelimEembryo.png")
