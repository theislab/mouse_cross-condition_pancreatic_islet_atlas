...
def moransi_conservation(adata_pre, 
                         adata_post, 
                         batch_key, 
                         embed,
                         n_hvg=1000, 
    ...
    if hvgs is None:
        hvgs= sc.pp.highly_variable_genes(adata_pre, batch_key=batch_key, 
                                           n_top_genes=2000, flavor='cell_ranger', inplace=False
                                           ).query('highly_variable').index.to_list()
